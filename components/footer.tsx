        ...
        <div className="container mx-auto grid grid-cols-2 gap-6 px-4 sm:grid-cols-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Authentic artisan craftsmanship</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Long-lasting shine &amp; finish</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Cash on Delivery across India</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Doorstep pickup available</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="relative h-10 w-10 overflow-hidden rounded-xl border border-stone-700 shadow-md bg-stone-900">
            ...
            <div className="flex items-center gap-3 pt-1">
              <Link href="https://instagram.com" className="flex h-8 w-8 items-center justify-center rounded-full bg-stone-800 text-rani hover:bg-stone-700 transition-colors border border-stone-700">
                <Instagram className="h-4 w-4" />
              </Link>
              <ReferralModal trigger={
                <button className="flex items-center gap-1 rounded-full bg-stone-800 px-3.5 py-1.5 text-xs font-bold text-amber-300 hover:bg-stone-700 transition-colors border border-stone-700">
                  <Heart className="h-3 w-3 text-rani fill-rani" /> Share with Besties
                </button>
              } />
            </div>
          </div>
          ...
          <div className="space-y-3 font-sans">
            ...
            <p className="text-xs text-stone-400">Get 10% off your first jewellery piece and early access to secret drops.</p>
            <NewsletterForm />
          </div>
        </div>

        {/* Bottom copyright */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-stone-800/80 pt-6 text-center text-xs text-stone-500 sm:flex-row sm:text-left font-sans">
          <p>© 2026 Jhumka Junction Jewellery Private Limited. Crafted with 💖 in India.</p>
          <p className="text-[11px] text-stone-500">Premium Handcrafted Jewellery • GST Compliant (CGST/SGST/IGST 3%)</p>
        </div>
      </div>
    </footer>
  );
